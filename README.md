...
Detailed benchmark methodology and raw results are available in [`benchmarks/`](benchmarks/).

<p align="center">
  <img src="images/render.png" alt="CUDA path tracer render" width="850">
</p>

<p align="center">
  <em>1200×675, 500 samples per pixel, 10 maximum bounces.</em>
</p>
...
The included `Makefile` provides targets for building and running both implementations.
...
Build both implementations with:

```sh
make
```

Remove generated binaries and PPM renders with:

```sh
make clean
```

The underlying compiler configuration is:
...
or converted to the PNG used in this repository with:

```sh
magick image.ppm images/render.png
```
